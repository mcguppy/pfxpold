...
this is a customised version of the original pfxpold tool of mschmitt:
https://github.com/mschmitt/pfxpold

This version uses a redis DB to put the mailquota and counters for sasl 
...
README of the original version of mschmitt:
